...
async function main() {
  ...
  const companyDefs = [
    ...
    },
    {
      ...
      logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS48hlthLhxmHKsnP5Ld6JQXPaHXr3R8c3gTg&s',
    },
    {
    ...
    // Alternatives
    { name: 'Second Cup Café', category: Category.RESTAURANT, website: 'https://secondcup.com',
    ...
    { name: 'Balzac’s Coffee Roasters', category: Category.RESTAURANT, website: 'https://www.balzacs.com',
      summary: 'Ontario-based coffee roaster and café chain known for handcrafted beverages, whole-bean coffee, and café fare.',
      logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCeh5xAUN_zl7OlZ8HJFHseiDVSACyqPMEWA&s',
    },
    { name: 'Mary Brown’s Chicken', category: Category.RESTAURANT, website: 'https://www.marybrowns.com',
    ...
    { name: 'Popeyes Louisiana Kitchen (Canada)', category: Category.RESTAURANT, website: 'https://www.popeyeschicken.ca',
    ...
    { name: 'Kotn', category: Category.APPAREL, website: 'https://kotn.com',
    ...
    { name: 'Frank And Oak', category: Category.APPAREL, website: 'https://www.frankandoak.com',
    ...
    { name: 'ESKA', category: Category.GROCERY, website: 'https://www.eskawater.com',
    ...
    { name: 'Flow Alkaline Spring Water', category: Category.GROCERY, website: 'https://flowhydration.ca',
    ...
    { name: 'New Balance (Canada)', category: Category.APPAREL, website: 'https://www.newbalance.ca',
    ...
    { name: 'ASICS (Canada)', category: Category.APPAREL, website: 'https://www.asics.com/ca',
      ...
      logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQphWOUUy_D_5Mh0Kl2xjNQAd9cljqUxK-Puw&s',
    },
    { name: 'eBay (Canada)', category: Category.OTHER, website: 'https://www.ebay.ca',
    ...
    { name: 'Etsy (Canada)', category: Category.OTHER, website: 'https://www.etsy.com/ca',
    ...
    { name: 'A&W (Canada)', category: Category.RESTAURANT, website: 'https://aw.ca',
    ...
    { name: 'Harvey’s', category: Category.RESTAURANT, website: 'https://www.harveys.ca',
    ...
    { name: 'Metro', category: Category.GROCERY, website: 'https://www.metro.ca',
    ...
    { name: 'Sobeys', category: Category.GROCERY, website: 'https://www.sobeys.com',
    ...
    { name: 'UNIQLO (Canada)', category: Category.APPAREL, website: 'https://www.uniqlo.com/ca',
    ...
    { name: 'Roots', category: Category.APPAREL, website: 'https://www.roots.com',
    ...
    { name: 'WestJet', category: Category.OTHER, website: 'https://www.westjet.com',
      summary: 'Canadian airline offering domestic and international flights with service across North America, Europe, and the Caribbean.',
      logoUrl: 'https://logo.clearbit.com/westjet.com',
    },
    { name: 'Porter Airlines', category: Category.OTHER, website: 'https://www.flyporter.com',
      summary: 'Regional and transcontinental airline based in Toronto, operating from Billy Bishop and Pearson with a growing Embraer fleet.',
      logoUrl: 'https://logo.clearbit.com/flyporter.com',
    },
  ]

  const companies = await Promise.all(companyDefs.map(c => prisma.company.create({ data: c })))
      ...
      sources: [
        {
          ...
          reliability: 0.7,
          claimExcerpt: 'Program overview: certified coffees, packaging, community.'
        },
        {
      ...
      sources: [
        {
          ...
          reliability: 0.7,
          claimExcerpt: 'LEAF certification, compostable pods, packaging notes.'
        },
        {
      ...
      sources: [
        {
          ...
          reliability: 0.6,
          claimExcerpt: 'Company profile; Canadian roots & sourcing statements.'
        },
        {
